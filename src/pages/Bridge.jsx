...
} from "../components/bridge-tab-content/BridgeTabContent.jsx";
import { useAccount } from "wagmi";
import "./css/bridge.css";
import SelectTokenModal from "../components/modal/SelectTokenModal.jsx";
import WithdrawToEthereum from "../components/bridge-tab-content/WithdrawToEthereum.jsx";
...
export default function Bridge({ title }) {
  ...
  return (
    <div>
      ...
      <div className="MuiBox-root css-14i99rr e1de0imv0 TSP-Medium">
        <div className="MuiContainer-root MuiContainer-maxWidthLg css-ef23km e1de0imv0">
          <div className="MuiStack-root css-19mh4ig e1de0imv0">
            ...
            <button
              className="MuiButtonBase-root css-ebuhoc-button e1de0imv0 focus:outline-none "
              tabIndex="0"
              type="button"
            ...
            >
              <svg
                ...
                className="MuiSvgIcon-root MuiSvgIcon-fontSizeMedium css-slq9qy e1de0imv0"
                focusable="false"
                aria-hidden="true"
              >
                <path
          ...
          <div className="MuiBox-root css-1tiyx7f-sendWrapper e1de0imv0">
            <div className="MuiTabs-root css-xxrxnx-tabList e1de0imv0">
              <div
                className="MuiTabs-scroller MuiTabs-fixed css-1w5l05g-tabList e1de0imv0"
                style={{ overflow: "hidden", marginBottom: 0 }}
              >
                <div
                  className="MuiTabs-flexContainer css-jfevyi-tabList e1de0imv0"
                  role="tablist"
                >
                  {/* buttons */}
                  ...
                  <button
                    ...
                    className={`${
                      tabOpen === "depositScroll" ? "bg-primary-fair " : ""
                    } css-5ui0rn-tab outline-none tsp-bold`}
                    tabIndex="0"
                    type="button"
                    role="tab"
                    aria-selected="true"
                    aria-controls="mui-p-49779-P-Deposit"
                  ...
                  <button
                    ...
                    className={`${
                      tabOpen === "withdrawEthereum" ? "bg-primary-fair " : ""
                    } css-5ui0rn-tab !outline-none border-none tsp-bold font-extrabold`}
                    tabIndex="-1"
                    type="button"
                    role="tab"
                    aria-selected="false"
                    aria-controls="mui-p-49779-P-Withdraw"
                    id="mui-p-49779-T-Withdraw"
                  >
                ...
                <span
                  className="MuiTabs-indicator css-1k456l7-indicator e1de0imv0"
            ...
            <div className=" bg-primary-fair">
              ...
              <div
                className={`${
                  tabOpen === "depositScroll" ? "block" : "hidden"
                }`}
              >
                <DepositTabContent />
              </div>
              ...
              <div
                className={`${
                  tabOpen === "withdrawEthereum" ? "block" : "hidden"
                } px-12`}
              >
                <WithdrawToEthereum
                  innerTabOpen={innerTabOpen}
                  setInnerTabOpen={setInnerTabOpen}
                />
              </div>
          ...
          <div className="MuiStack-root css-1e0dkkg e1de0imv0">
            <a className="css-11x14hs e1de0imv0" href="/bridge/faq">
              FAQs
              <svg
                width="23"
                height="23"
            ...
            <a
              className="css-11x14hs e1de0imv0"
              href="https://sepolia.scroll.io/bridge"
              target="_blank"
            >
              Testnet Bridge
              <svg
            ...
            <a className="css-11x14hs e1de0imv0" href="/terms-of-service">
              Terms of Service
              <svg
                width="23"
                height="23"
