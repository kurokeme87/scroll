                                                ...
                                                <div className='mega-menu shadow-md absolute z-50'>
                                                    ...
                                                    <div className='flex'>
                                                        ...
                                                        <div className='second-column'>
                                                            <div>
                                                                <p>BLOCK EXPLORERS</p>
                                                                <Link to="https://scrollscan.com/" className='block text-black'>Scrollscan</Link>
                                                                <Link to="https://scroll.l2scan.co/" className='block text-black'>L2 Scan</Link>
                                                                <Link to="https://www.ondora.xyz/network/scroll/interactions" className='block text-black'>Dora Explorer</Link>
                                                                <Link to="https://www.okx.com/web3/explorer/scroll?channelId=scroll" className='block text-black'>OKX Explorer</Link>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
