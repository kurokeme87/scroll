...
export default function ConnectWalletBtn({ variant = "default-btn", children }) {
    return (
        <div>
            {/* this button is for navigation */}
            {variant === "nav-btn" && <button className="MuiButtonBase-root css-17lfbyv-button-connectButton e1de0imv0" tabIndex="0" type="button">
                {children}
            </button>}
